...
// 			gameServiceMock.Setup(gs => gs.IsTitleUniqueAsync(Factory.GamesFactory.Game1Title, It.IsAny<Guid?>(), default))
// 				.Returns(Task.FromResult(false));
//
// 			gameServiceMock.Setup(gs => gs.IsTitleUniqueAsync(Factory.GamesFactory.Game2Title, It.IsAny<Guid?>(), default))
// 				.Returns(Task.FromResult(true));
//
// 			_sut = new IsTitleUniqueQueryHandler(gameServiceMock.Object);
// 		}
//
// 		[TestCase(Factory.GamesFactory.Game1Title, false)]
// 		[TestCase(Factory.GamesFactory.Game2Title, true)]
