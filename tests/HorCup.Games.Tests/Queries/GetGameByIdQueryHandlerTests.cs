...
// 	{
// 		private readonly Factory.GamesFactory _factory = new();
...
// 			details.Title.Should().Be(Factory.GamesFactory.Game4Title);
// 			details.MaxPlayers.Should().Be(Factory.GamesFactory.Game4MaxPlayers);
// 			details.MaxPlayers.Should().Be(Factory.GamesFactory.Game4MaxPlayers);
// 		}
// 	}
// }